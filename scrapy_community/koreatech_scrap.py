# -*- coding: utf-8 -*-
"""
Created on Mon Mar  4 16:27:14 2024
...
def scrape_university_reviews(university_name):
    base_url = 'https://gall.dcinside.com/board/view/?id=koreatech&no={}'  # {}에는 게시물 번호가 들어갈 자리입니다.
...
def save_to_database(university_name, soup):
    conn = sqlite3.connect('university_reviews_koreatech.db')
    cursor = conn.cursor()
